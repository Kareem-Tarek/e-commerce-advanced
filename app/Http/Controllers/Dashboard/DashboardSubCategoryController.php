...
class DashboardSubCategoryController extends Controller
{
    ...
    {   
        ...
        $request->description != $sub_categories_old->description){
            ...
            $sub_categories->save();
            return redirect()->route('subcategories.index')
            ->with(['updated_sub_category_message' => "The sub-category ($sub_categories_old->name) has been changed to ($sub_categories->name) + its description successfully!"]);
        }
        ...
        $request->description == $sub_categories_old->description){
            ...
            $sub_categories->save();
            return redirect()->route('subcategories.index')
            ->with(['updated_sub_category_message' => "The sub-category ($sub_categories_old->name) has been changed to ($sub_categories->name) + its category successfully!"]);
        }
