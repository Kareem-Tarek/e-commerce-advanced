...
@section('content')
<main class="main" style="margin-top: 10%; margin-bottom: 0.35%;">
    <div class="soon">
        <div class="container">
            <div class="row">
...
@section('scripts')
<script> //this script is used for "Coming Soon" blade!
    $(function() {
        "use strict";
        if ($.fn.countdown) {
            $('.coming-countdown').countdown({
                until: new Date(2023, 7, 20), // 7th month = August / Months 0 - 11 (January  - December)
                format: 'DHMS',
                padZeroes: true
            });
