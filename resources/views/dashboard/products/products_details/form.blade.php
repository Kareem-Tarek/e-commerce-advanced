...
<div class="form-group">
    ...
    <input name="name" type="text" class="form-control @error('name') is-invalid @enderror" value="{{Request::old('name') ? Request::old('name') : $ProductDetail_model->name}}" placeholder="Enter name here..">
    @error('name')
...
<div class="form-group">
    ...
    <input name="description" type="text" class="form-control @error('description') is-invalid @enderror" value="{{Request::old('description') ? Request::old('description') : $ProductDetail_model->description}}" placeholder="Enter description here..">
    @error('description')
        <span class="invalid-feedback" role="alert">
            <strong>{{ $message }}</strong>
        </span>
...
<div class="form-group">
    ...
    <select name="discount" class="form-control select discount @error('discount') is-invalid @enderror" id="discount">
...
<div class="form-group">
    ...
    <select name="sub_cat_id" class="form-control select mb-2 @error('sub_cat_id') is-invalid @enderror" value="{{Request::old('sub_cat_id') ? Request::old('sub_cat_id') : $ProductDetail_model->sub_cat_id}}">
...
<div class="form-group">
    ...
    <input name="brand_name" type="text" class="form-control @error('brand_name') is-invalid @enderror" value="{{Request::old('brand_name') ? Request::old('brand_name') : $ProductDetail_model->brand_name}}" placeholder="Enter brand name here..">
    @error('brand_name')
        <span class="invalid-feedback" role="alert">
            <strong>{{ $message }}</strong>
        </span>
